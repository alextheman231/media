...
from patch_it_up.end_screen.helpers.create_checks_passed_banner import (
    create_checks_passed_banner,
)
from patch_it_up.end_screen.helpers.text_group import text_group
from patch_it_up.end_screen.helpers.tick import tick
